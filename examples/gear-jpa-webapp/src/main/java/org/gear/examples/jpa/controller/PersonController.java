...
public class PersonController extends AbstractController {
    ...
    protected static final String MODEL_ATTRIBUTE_PERSON = "person";
    ...
    public String delete(@PathVariable("id") Long id, RedirectAttributes attributes) {
    	...
    	return createdRedirectViewPath(REQUEST_MAPPING_LIST);
    }
    ...
    public String showCreatePersonForm(Model model) {
    	...
    	model.addAttribute(MODEL_ATTRIBUTE_PERSON, new PersonDTO());
    ...
    public String submitCreatePersonForm(
    		@Valid @ModelAttribute(MODEL_ATTRIBUTE_PERSON) PersonDTO created, 
    		BindingResult bindingResult, 
    		RedirectAttributes attributes) {
    	LOGGER.debug("Create person from was submitted with infomation: " + created);
    ...
    public String showEditPersonForm(@PathVariable("id") Long id, Model model, RedirectAttributes attributes) {
    	...
    	model.addAttribute(MODEL_ATTRIBUTE_PERSON, constructFormObject(person));
    ...
    public String submitEditPersonForm(
    		@Valid @ModelAttribute(MODEL_ATTRIBUTE_PERSON) PersonDTO updated,
    		BindingResult bindingResult,
    		RedirectAttributes attributes) {
    	...
    	try {
    		...
    		LOGGER.debug("No person was found withd id: " + updated.getId());
    		addErrorMessage(attributes, ERROR_MESSAGE_KEY_EDITED_PERSON_WAS_NOT_FOUND);
    	}
